...
const RETRY_DELAY = 10000; // 1 segundo entre reintentos
const MAX_RETRIES = 5; // Máximo de reintentos tras errores
const COMMAND_DEBOUNCE = 2000; // Tiempo mínimo entre comandos procesados
